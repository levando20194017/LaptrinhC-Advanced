...
void information(){
	...
	SetColor(4);
	gotoxy(10,8);
	printf("moi gop y vui long gui ve hom thu maildithidaihoc@gmail.com");
		gotoxy(8,9);
		printf("hoac lien he fb: https://www.facebook.com/nguoithichban.ghet.9");
		gotoxy(3,10);
		printf("chuc ae hoc tap hieu qua hon qua vi du nay, an phim bat ki de tro lai menu");
		gotoxy(27,11);
		SetColor(14);
		printf("----anh's thanh----");
		getchar();
